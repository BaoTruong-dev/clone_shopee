...
export default function NotFound() {
  return (
    <div className='h-screen'>
      <div className='flex h-full flex-col items-center justify-center container'>
        <center>
          <svg
            className='emoji-404 '
          ...
          <div className=' mt-4 tracking-widest'>
            ...
            <span className='text-xl text-gray-500'>Xin lỗi, chúng tôi không tìm thấy trang của bạn!</span>
          </div>
        </center>
        <center className='mt-6'>
          <Link to='/' className='rounded-md bg-gray-200 p-3  text-xl text-gray-500 hover:shadow-md'>
            Trở lại trang chủ
          </Link>
        </center>
      </div>
